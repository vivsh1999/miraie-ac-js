...
export const ENERGY_CONSUMPTION_URL = "https://app.miraie.in/simplifi/v1/powerConsumption/devices/{deviceId}?grain={periodType}&startDate={fromDate}&endDate={toDate}";
